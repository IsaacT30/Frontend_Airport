    ...
    <PrivateLayout>
      <div>
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-gray-900">📦 Catalogar</h1>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 text-center">
          ...
          <p className="text-yellow-800 mb-4">
            Este módulo requiere el endpoint <code className="bg-yellow-100 px-2 py-1 rounded">/api/catalog/</code> que no está desplegado en el backend actual.
          </p>
